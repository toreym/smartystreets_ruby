...
module SmartyStreets
  ...
  class BaseJsonObject
    ...
    def get_optional_float(hash, key)
      hash[key] ? check_type(hash[key], Float) : nil
    end
    ...
    def get_optional_hash(hash, key)
      hash[key] && !hash[key].empty? ? check_type(hash[key], Hash) : nil
    end
    ...
    def get_optional_array(hash, key)
      hash[key] && !hash[key].empty? ? check_type(hash[key], Array) : nil
    end
